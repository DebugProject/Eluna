...
ElunaRegister<Unit> UnitMethods[] =
{
    ...
    {"HasAura", &LuaUnit::HasAura},                         // :HasAura(spellId) - Returns true if the unit has the aura from the spell and casted by the caster if provided
...
ElunaRegister<GameObject> GameObjectMethods[] =
{
    ...
    {"RemoveFromWorld", &LuaGameObject::RemoveFromWorld},   // :RemoveFromWorld()
