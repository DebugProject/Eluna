...
{
#ifdef ELUNA
    sHookMgr->OnMoneyChanged(player, (int32&)amount);
#endif
...
{
#ifdef ELUNA
    sHookMgr->OnMemberWitdrawMoney(guild, player, (uint32&)amount, isRepair);
#endif
...
{
#ifdef ELUNA
    sHookMgr->OnMemberDepositMoney(guild, player, (uint32&)amount);
#endif
